...
setup_mkdocs() {
  /bin/bash <(curl -H "Authorization: token ${TOKEN}" https://raw.githubusercontent.com/department-of-veterans-affairs/lighthouse-github-actions/main/scripts/setup_mkdocs.sh)
}
