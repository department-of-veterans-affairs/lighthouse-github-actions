...
set_techdocs_args () {
  ...
  techdocs_publish_args="techdocs-cli publish --publisher-type awsS3 --storage-name embark-techdocs-storage-nonprod --entity ${team_name}/${kind}/${name} --directory /tmp/git/techdocs/${repo}"
}
